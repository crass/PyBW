...
def getNearestUnwalkablePolygon(*args):
  return _pybw_swig.getNearestUnwalkablePolygon(*args)
getNearestUnwalkablePolygon = _pybw_swig.getNearestUnwalkablePolygon
...
class Event(_object):
    ...
    __swig_getmethods__["Disconnect"] = lambda x: _pybw_swig.Event_Disconnect
    if _newclass:Disconnect = staticmethod(_pybw_swig.Event_Disconnect)
...
def Event_Disconnect():
  return _pybw_swig.Event_Disconnect()
Event_Disconnect = _pybw_swig.Event_Disconnect
...
class Player(_object):
    ...
    def getType(self, *args): return _pybw_swig.Player_getType(self, *args)
...
QueenHoldPosition = cvar.QueenHoldPosition
Cloak = cvar.Cloak
...
SuicideHoldPosition = cvar.SuicideHoldPosition
...
Unload_All = cvar.Unload_All
Unload_All_Position = cvar.Unload_All_Position
Cancel_Construction = cvar.Cancel_Construction
Halt_Construction = cvar.Halt_Construction
Cancel_Morph = cvar.Cancel_Morph
Cancel_Train = cvar.Cancel_Train
Cancel_Train_Slot = cvar.Cancel_Train_Slot
Cancel_Addon = cvar.Cancel_Addon
Cancel_Research = cvar.Cancel_Research
Cancel_Upgrade = cvar.Cancel_Upgrade
Use_Tech = cvar.Use_Tech
Use_Tech_Position = cvar.Use_Tech_Position
Use_Tech_Unit = cvar.Use_Tech_Unit
...
class Polygon(PositionVector):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _pybw_swig.new_Polygon(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    def getHoles(self): return _pybw_swig.Polygon_getHoles(self)
    __swig_setmethods__["holes"] = _pybw_swig.Polygon_holes_set
    __swig_getmethods__["holes"] = _pybw_swig.Polygon_holes_get
    if _newclass:holes = _swig_property(_pybw_swig.Polygon_holes_get, _pybw_swig.Polygon_holes_set)
